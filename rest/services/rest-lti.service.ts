...
export class RestLtiService extends AbstractRestService {
    ...
    public registrationAdvanced = (platformId: string,
                                   clientId: string,
                                   deploymentId: string,
        ...
        const query = this.connector.createUrl('/lti/v13/registration/static?platformId=:platformId&client_id=:client_id&deployment_id=:deployment_id&authentication_request_url=:authentication_request_url&keyset_url=:keyset_url&key_id=:key_id&auth_token_url=:auth_token_url',
            null, [[':platformId', platformId],
                [':client_id', clientId],
