...
export class RestCollectionService extends AbstractRestService {
    ...
    public deleteCollection = (
        ...
        const query = this.connector.createUrl(
            'collection/:version/collections/:repository/:collection',
            repository,
            [[':collection', collection]],
        );
        return this.connector.delete(query, this.connector.getRequestOptions());
    };
    public addNodeToCollection = (
        collection: string,
        node: string,
        sourceRepo: string,
        ...
        const query = this.connector.createUrl(
            'collection/:version/collections/:repository/:collection/references/:node?sourceRepo=:sourceRepo&allowDuplicate=:allowDuplicate&asProposal=:asProposal',
            repository,
            [
                [':collection', collection],
                [':node', node],
    ...
    public setPinning = (
        ...
        const query = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/pinning',
            repository,
        );
    ...
    public setOrder = (
        ...
        const query = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/:collection/order',
            repository,
            [[':collection', collection]],
        );
        return this.connector.post(
    ...
    public search = (
        ...
        const http = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/search?query=:query&:request',
            repository,
            [
        ...
        return this.connector.get<CollectionSubcollections>(
            http,
            this.connector.getRequestOptions(),
        );
    };
    ...
    public getCollectionSubcollections = (
        ...
        const query = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/:collection/children/collections?scope=:scope&:propertyFilter&:request',
            repository,
            [
        ...
        return this.connector.get<EduData.CollectionSubcollections>(
            query,
            this.connector.getRequestOptions(),
        );
    };
    public getCollectionReferences = (
        ...
        const query = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/:collection/children/references?:propertyFilter&:request',
            repository,
            [
                [':collection', encodeURIComponent(collection)],
                [':request', this.connector.createRequestString(request)],
        ...
        return this.connector.get<EduData.CollectionReferences>(
            query,
            this.connector.getRequestOptions(),
        );
    };
    public getCollectionProposals = (
        ...
        const query = this.connector.createUrlNoEscape(
            'collection/:version/collections/:repository/:collection/children/proposals?status=:status',
            repository,
            [
                [':collection', encodeURIComponent(collection)],
        ...
        return this.connector.get<AbstractList<ProposalNode>>(
            query,
            this.connector.getRequestOptions(),
        );
    };
    public getCollectionMetadata = (
        ...
        const query = this.connector.createUrl(
            'collection/:version/collections/:repository/:collectionid',
            repository,
    ...
    public createCollection = (
        ...
        parentCollectionId: string = RestConstants.ROOT,
        repository: string = RestConstants.HOME_REPOSITORY,
    ) => {
        const query: string = this.connector.createUrl(
            'collection/:version/collections/:repository/:collectionid/children',
            repository,
            [[':collectionid', parentCollectionId]],
        );
        const options = this.connector.getRequestOptions();
        return this.connector.post<EduData.CollectionWrapper>(
            query,
    ...
    public deleteCollectionImage = (
        ...
        const query = this.connector.createUrl(
            'collection/:version/collections/:repository/:collectionid/icon',
            repository,
            [[':collectionid', collectionId]],
        );
        const options = this.connector.getRequestOptions();
    ...
    public removeFromCollection = (
        ...
        const query: string = this.connector.createUrl(
            'collection/:version/collections/:repository/:collectionid/references/:refid',
            repository,
            [
                [':collectionid', collectionId],
                [':refid', referenceId],
