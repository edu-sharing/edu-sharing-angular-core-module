...
export class RestConstants {
  ...
  public static VALID_GROUP_TYPES = [null,RestConstants.GROUP_TYPE_ADMINISTRATORS,RestConstants.GROUP_TYPE_MEDIA_CENTER,RestConstants.GROUP_TYPE_MEDIACENTER_PROXY,RestConstants.GROUP_TYPE_MEDIACENTER_ADMINISTRATORS,RestConstants.GROUP_TYPE_EDITORIAL,RestConstants.GROUP_TYPE_TEACHER];
